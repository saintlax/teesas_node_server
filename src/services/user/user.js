 ...
 */
 ...
 const { createSchema, updateSchema } = require('../../validators/user');
 
 /**
  *
  * This is the integration of the User model routes with the User model controller bridging by holding core business logic.
  * @class
  */
 class UserService extends RootService {
     ...
     /**
     *
     * This method is an implementation to handle the business logic of logging users in. This validates the user details and generate tokens if valid.
     * This should be used alongside a POST Request alone.
     * @async
     * @method
     * @param {RequestFunctionParameter} {@link RequestFunctionParameter}
    ...
    async loginUser({ request, next }) {
        try {
            ...
            if (!correctPassword) throw new Error('Incorrect Phone or Password combination.');
